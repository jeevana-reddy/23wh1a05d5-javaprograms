<!DOCTYPE html>
<!-- saved from url=(0047)https://www.onlinegdb.com/online_java_compiler# -->
...
<meta name="verify-admitad" content="fb09364f2b">
    ...
    <link rel="stylesheet" href="./inhrtns1_files/bootstrap.min.css">

    
    <link rel="stylesheet" href="./inhrtns1_files/onlinegdb.css">
    
    
    <script async="" src="https://c.amazon-adsystem.com/aax2/apstag.js"></script><script async="" src="./inhrtns1_files/clarity.js"></script><script async="" src="./inhrtns1_files/ew6y4c1gqd"></script><script type="text/javascript" async="" src="./inhrtns1_files/analytics.js"></script><script type="text/javascript" async="" src="./inhrtns1_files/js"></script><script async="" src="./inhrtns1_files/gtm.js"></script><script>  var main_ide =  true;  </script>
    
    
    <script type="text/javascript" src="./inhrtns1_files/onlinegdb.js"></script><style type="text/css">  .JColResizer{table-layout:fixed;} .JColResizer > tbody > tr > td, .JColResizer > tbody > tr > th{overflow:hidden}  .JPadding > tbody > tr > td, .JPadding > tbody > tr > th{/*padding-left:0!important; */padding-right:0!important;} .JCLRgrips{ height:0px; position:relative;} .JCLRgrip{margin-left:-5px; position:absolute; z-index:5; } .JCLRgrip .JColResizer{position:absolute;background-color:red;filter:alpha(opacity=1);opacity:0;width:10px;height:100%;cursor: col-resize;top:0px} .JCLRLastGrip{position:absolute; width:1px; } .JCLRgripDrag{ border-left:1px dotted black;	} .JCLRFlex{width:auto!important;} .JCLRgrip.JCLRdisabledGrip .JColResizer{cursor:default; display:none;}</style>
    <script type="text/javascript" src="./inhrtns1_files/ace.js"></script>
    <script type="text/javascript" src="./inhrtns1_files/ext-language_tools.js"></script>
    <script type="text/javascript" src="./inhrtns1_files/editor.js" defer=""></script>
    <script type="text/javascript" src="./inhrtns1_files/main.js" defer=""></script>
    

    <link rel="stylesheet" href="./inhrtns1_files/bootstrap-select.min.css">
    <script src="./inhrtns1_files/bootstrap-select.min.js"></script>
    ...
    </script><script type="text/javascript" async="" src="./inhrtns1_files/onlinegdb(1).js"></script>
    <script type="text/javascript" src="./inhrtns1_files/monetization.js"></script>
...
-->
<script src="./inhrtns1_files/theme-idle_fingers.js"></script><script src="./inhrtns1_files/mode-java.js"></script><div id="_bsa_srv-CK7I6K7M_1"></div><div id="_bsa_srv-CW7D627U_0"></div><script src="./inhrtns1_files/java.js"></script><script async="" src="./inhrtns1_files/tag" dropped-by="bsaoptimize"></script><script async="" type="text/javascript" src="https://securepubads.g.doubleclick.net/tag/js/gpt.js" dropped-by="bsaoptimize"></script><style id="bsa_extra-css"></style><script>(function(){{const e=RegExp.prototype.test;RegExp.prototype.test=function(t){return e.call(this,t)}}["requestAnimationFrame","requestIdleCallback","setInterval","setTimeout"].filter((e=>window[e])).forEach((e=>window[e]=t(window[e],e))),EventTarget.prototype.addEventListener=t(EventTarget.prototype.addEventListener,"addEventListener",1),EventTarget.prototype.removeEventListener=t(EventTarget.prototype.removeEventListener,"removeEventListener",1);const e=new Map;function t(t,n,r=0){return function(...i){const o=i.slice(0,r),s=i[r],l=i.slice(r+1);if(!s)return t.call(this,...i);if("setInterval"!==n&&"setTimeout"!==n&&"function"!=typeof s&&"function"!=typeof s.handleEvent)return t.call(this,...i);let a=null;if("addEventListener"===n||"removeEventListener"===n){const t=o[0];e.get(this)||e.set(this,new Map),e.get(this).get(t)||e.get(this).set(t,new Map),a=e.get(this).get(t).get(s)}if(a=a||function(...e){if("function"==typeof s)return s.call(this,...e);if("string"==typeof s)return window.eval(s);if("function"==typeof s.handleEvent)return s.handleEvent.call(s,...e);throw new Error("Failed to register callback - invalid callback type: "+typeof s)},"addEventListener"===n){const t=o[0];e.get(this).get(t).set(s,a)}else if("removeEventListener"===n){const n=o[0],r=e.get(this).get(n).get(s)||s;return e.get(this).get(n).delete(s),t.call(this,...o,r,...l)}return t.call(this,...o,a,...l)}}})()</script><link rel="preconnect" href="https://0.fb.html-load.com/"><link rel="preconnect" href="https://1.fb.html-load.com/"><link rel="preconnect" href="https://2.fb.html-load.com/"><link rel="preconnect" href="https://3.fb.html-load.com/"><link rel="preconnect" href="https://4.fb.html-load.com/"><link rel="preconnect" href="https://5.fb.html-load.com/"><link rel="preconnect" href="https://6.fb.html-load.com/"><link rel="preconnect" href="https://7.fb.html-load.com/"><link rel="preconnect" href="https://8.fb.html-load.com/"><link rel="preconnect" href="https://9.fb.html-load.com/"><link rel="preload" as="script" href="https://fb.html-load.com/fl1hrrg/www.onlinegdb.com/-1/70/984/130/m/vkdsgkckckjkskiffk221k6gkcmj2pj8k5dk62c8mfk2k6mwvk69ks?h=50364605"></head>
...
<center style="display: none !important;">
    ...
    <script async="" type="text/javascript" src="https://cdn.carbonads.com/carbon.js?serve=CKYI5KJI&amp;placement=onlinegdbcom" id="_carbonads_js"></script> 
    
    </div>
</center>
        
        <span style="display: block; margin-top: 30px;" id="jizsl_vkds212cku21h2t0klii21kmj" class="jizsl_vkdskgk7bbskmk5"><div style="display: flex; justify-content: center; align-items: center; position: relative;"><iframe src="./inhrtns1_files/saved_resource.html" enjgioijew="" width="200" height="202" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="margin: 0px; padding: 0px; height: 202px !important;" status="success"></iframe></div></span><footer class="container-fluid text-center" style="bottom:0px;left:0px;right:0px;position:absolute;padding:3px;">
        <style type="text/css">
#footer a {
    font-weight: normal;
...
<span style="float:none;clear:both">© 2016 - 2024 GDB Online</span>
    ...
    <div class="split-pane-component" id="right-component">
        ...
        <script src="./inhrtns1_files/js-dos.js"></script>
            ...
            <span class="col-sm-63" id="control-bar" style="float:left">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="https://www.onlinegdb.com/online_java_compiler#" onclick="downloadCode(true)">Download all files</a></li>
                    </ul>
                </div>
...
<!--                  <option  value="c++11">C++ 11</option> -->
    ...
    <div style="clear:both; background-color:#757575; overflow: auto; scrollbar-width: none;">
        <ul class="editor_file_tabs nav nav-pills" style="display: inline-flex;  overflow-x: scroll; overflow-y: hidden; height: 100px;">
            ...
            <li class="active">
                <a href="https://www.onlinegdb.com/online_java_compiler#editor_1" data-toggle="tab"><span class="filename">inhrtns1.java</span>
                </a>
                
                <div class="dropdown">
                    <span class="dropbtn glyphicon glyphicon-option-vertical"></span>
                    <div class="dropdown-content" style="left:-50px;">
                        <a href="https://www.onlinegdb.com/online_java_compiler#" class="menu_item menu_item_rename">Rename</a>
                    </div>
                </div>
    ...
    <div class="editor_text_panes tab-content clearfix">
        ...
        <div id="editor_1" data-format="S" data-readonly-ranges="" class="tab-pane active editor ace_editor ace_hidpi ace-idle-fingers ace_dark" style="font-size: medium;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; font-size: 1px; height: 1px; width: 1px; transform: translate(141px, 240px);"></textarea><div class="ace_gutter" aria-hidden="true" style="left: 0px; width: 49px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; transform: translate(0px, 0px); width: 49px;"><div class="ace_gutter-cell " style="height: 16px; top: 0px;">1<span class="ace_fold-widget ace_start ace_open" style="display: inline-block; height: 16px;"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 16px;">2<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 32px;">3<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 48px;">4<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 64px;">5<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 80px;">6<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 96px;">7<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 112px;">8<span style="display: inline-block; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 128px;">9<span style="display: inline-block; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 144px;">10<span class="ace_fold-widget ace_start ace_open" style="display: none; height: 16px;"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 160px;">11<span class="ace_fold-widget ace_start ace_open" style="display: none; height: 16px;"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 176px;">12<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 192px;">13<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 208px;">14<span style="display: inline-block; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell ace_gutter-active-line " style="height: 16px; top: 224px;">15<span style="display: inline-block; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 240px;">16<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 256px;">17<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 272px;">18<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 288px;">19<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 304px;">20<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 320px;">21<span style="display: inline-block; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 336px;">22<span style="display: inline-block; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 352px;">23<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 368px;">24<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 384px;">25<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 400px;">26<span style="display: none; height: 16px;" class="ace_fold-widget ace_start ace_open"></span></div><div class="ace_gutter-cell " style="height: 16px; top: 416px;">27<span style="display: none;"></span></div></div></div><div class="ace_scroller" style="line-height: 16px; left: 49px; right: 0px; bottom: 0px;"><div class="ace_content" style="transform: translate(0px, 0px); width: 1417px; height: 669px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 644px; visibility: visible;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height: 16px; top: 224px; left: 0px; right: 0px;"></div></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; transform: translate(0px, 0px);"><div class="ace_line" style="height: 16px; top: 0px;"><span class="ace_comment ace_doc">/******************************************************************************</span></div><div class="ace_line" style="height: 16px; top: 16px;"></div><div class="ace_line" style="height: 16px; top: 32px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_comment ace_doc">    Online Java Compiler.</span></div><div class="ace_line" style="height: 16px; top: 48px;"><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_indent-guide">    </span><span class="ace_comment ace_doc">    Code, Compile, Run and Debug java program online.</span></div><div class="ace_line" style="height: 16px; top: 64px;"><span class="ace_comment ace_doc">Write your code in this editor and press "Run" button to execute it.</span></div><div class="ace_line" style="height: 16px; top: 80px;"></div><div class="ace_line" style="height: 16px; top: 96px;"><span class="ace_comment ace_doc">*******************************************************************************/</span></div><div class="ace_line" style="height: 16px; top: 112px;"><span class="ace_keyword">class</span> <span class="ace_identifier">A</span>{</div><div class="ace_line" style="height: 16px; top: 128px;">    <span class="ace_keyword">static</span> <span class="ace_keyword">void</span> <span class="ace_identifier">display</span>(){</div><div class="ace_line" style="height: 16px; top: 144px;"><span class="ace_indent-guide">    </span>    <span class="ace_support ace_function">System</span>.<span class="ace_identifier">out</span>.<span class="ace_identifier">println</span>(<span class="ace_string">"this is parent class"</span>);</div><div class="ace_line" style="height: 16px; top: 160px;"><span class="ace_indent-guide">    </span>    </div><div class="ace_line" style="height: 16px; top: 176px;">    }</div><div class="ace_line" style="height: 16px; top: 192px;">}</div><div class="ace_line" style="height: 16px; top: 208px;"><span class="ace_keyword">class</span> <span class="ace_identifier">B</span> <span class="ace_keyword">extends</span> <span class="ace_identifier">A</span>{</div><div class="ace_line" style="height: 16px; top: 224px;">    <span class="ace_keyword">static</span> <span class="ace_keyword">void</span> <span class="ace_identifier">greeting</span>(){</div><div class="ace_line" style="height: 16px; top: 240px;"><span class="ace_indent-guide">    </span>    <span class="ace_support ace_function">System</span>.<span class="ace_identifier">out</span>.<span class="ace_identifier">println</span>(<span class="ace_string">"Hello! GOOD MORNING....:)"</span>);</div><div class="ace_line" style="height: 16px; top: 256px;">    }</div><div class="ace_line" style="height: 16px; top: 272px;">}</div><div class="ace_line" style="height: 16px; top: 288px;"></div><div class="ace_line" style="height: 16px; top: 304px;"><span class="ace_keyword">public</span> <span class="ace_keyword">class</span> <span class="ace_identifier">inhrtns1</span></div><div class="ace_line" style="height: 16px; top: 320px;">{</div><div class="ace_line" style="height: 16px; top: 336px;">    <span class="ace_keyword">public</span> <span class="ace_keyword">static</span> <span class="ace_keyword">void</span> <span class="ace_identifier">main</span>(<span class="ace_support ace_function">String</span>[] <span class="ace_identifier">args</span>) {</div><div class="ace_line" style="height: 16px; top: 352px;">        <span class="ace_identifier">B</span> <span class="ace_identifier">myobj</span> <span class="ace_keyword ace_operator">=</span> <span class="ace_keyword">new</span> <span class="ace_identifier">B</span>();</div><div class="ace_line" style="height: 16px; top: 368px;">        <span class="ace_identifier">B</span>.<span class="ace_identifier">display</span>();</div><div class="ace_line" style="height: 16px; top: 384px;">        <span class="ace_identifier">B</span>.<span class="ace_identifier">greeting</span>();</div><div class="ace_line" style="height: 16px; top: 400px;">}</div><div class="ace_line" style="height: 16px; top: 416px;">}</div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors"><div class="ace_cursor" style="display: block; transform: translate(92px, 224px); width: 8px; height: 16px; animation-duration: 1000ms;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="display: none; width: 20px; bottom: 0px;"><div class="ace_scrollbar-inner" style="width: 20px; height: 432px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 49px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 1466px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;"></div></div></div>
        
    </div>
    <div id="sidebar_adunit_wrapper" style="display: none;">
        <div class="col-sm-12 text-right" style="padding-bottom: 10px;">
        <a href="https://www.onlinegdb.com/online_java_compiler#" onclick="hide_sidebar_adunit_wrapper();" style="color:white;"> close ad [x]</a></div>
...
<div id="jizsl_dggngw6laga6xac2ygaa9agg72da9gw" style="display: block; width: 300px; height: 100%; position: absolute; top: 52px; right: 0px; bottom: 0px; background: rgb(98, 97, 97); z-index: 1000;"><div class="col-sm-12 text-right" style="padding-bottom: 10px;">
<a href="https://www.onlinegdb.com/online_java_compiler#" onclick="this.parentNode.parentNode.style.display = &#39;none&#39;;" style="color:white;"> close ad [x]</a>
</div><div id="jizsl_dggngw6laga6xm" style="margin-bottom: 28px;"><span style="width: 100%; display: flex; align-items: center; justify-content: center;" id="jizsl_ithcm188vd13" class="jizsl_vkdskc21kgwskjwkhkukb4tk5"><div style="display: flex; justify-content: center; align-items: center; position: relative;"><iframe src="./inhrtns1_files/saved_resource(1).html" enjgioijew="" width="300" height="252" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="margin: 0px; padding: 0px; height: 252px !important;" status="success"></iframe></div></span></div><div id="jizsl_dggngw6laga6xi"><span style="width: 100%; display: flex; align-items: center; justify-content: center;" id="jizsl_vkdsjkakjkjk0" class="jizsl_irrrfouh6h4et4o1mo6"><div style="display: flex; justify-content: center; align-items: center; position: relative;"><iframe src="./inhrtns1_files/saved_resource(2).html" enjgioijew="" width="300" height="252" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="margin: 0px; padding: 0px; height: 252px !important;" status="success"></iframe></div></span></div></div></div> 
</div>
                        <!-- middle top end -->
                    </div>
    ...
    <div id="console-fadder" style="display: none;">
        <center><img src="./inhrtns1_files/loading.gif"><img>
        ...
        <div id="tab-stdin" class="tab-pane fade active in" style="display: block;">
            ...
            <div class="well" style="position:absolute; padding-top:0px; width:100%;top:37px; bottom:0px;border-radius:0px;padding:9px;">
                ...
                <input type="radio" id="input_method_interactive" name="input_method" value="interactive" checked=""> Interactive Console
                    ...
                    <div id="ad_unit_bottom_wrapper" style="display: none !important;">
            ...
            <div id="interactive-terminal-container" style="position:absolute; margin:0px;top:0px; bottom:0px; left:0px; right:0px;" class="col-sm-121"><div dir="ltr" class="terminal xterm" tabindex="0" role="document"><div class="xterm-viewport" style="background-color: rgb(0, 0, 0);"><div class="xterm-scroll-area" style="height: 187px;"></div></div><div class="xterm-screen" style="width: 1449px; height: 187px;"><div class="xterm-helpers"><textarea class="xterm-helper-textarea" aria-label="Terminal input" aria-multiline="false" autocorrect="off" autocapitalize="off" spellcheck="false" tabindex="0" style="left: 252.438px; top: 85px; width: 9.01562px; height: 17px; line-height: 17px; z-index: -5;"></textarea><span class="xterm-char-measure-element" aria-hidden="true" style="font-family: courier-new, courier, monospace; font-size: 15px;">W</span><div class="composition-view"></div></div><canvas class="xterm-text-layer" width="1449" height="187" style="z-index: 0; width: 1449px; height: 187px;"></canvas><canvas class="xterm-selection-layer" width="1449" height="187" style="z-index: 1; width: 1449px; height: 187px;"></canvas><canvas class="xterm-link-layer" width="1449" height="187" style="z-index: 2; width: 1449px; height: 187px;"></canvas><canvas class="xterm-cursor-layer" width="1449" height="187" style="z-index: 3; width: 1449px; height: 187px;"></canvas></div></div></div>
...
<div class="panel panel-default panel-registers">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" class="collapse-toggle" href="https://www.onlinegdb.com/online_java_compiler#debug_window_registers">Registers</a>
      </h4>
    </div>
...
<!--<script src="//control.mockingfish.com/js/011503.js"></script>-->
    ...
    <!-- Rename file Modal -->
    <div id="renameFileModal" class="modal fade" role="dialog" style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">×</button>
...
<script async="" src="./inhrtns1_files/js(1)"></script>
<script>
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'8c56f8db1b202ce6',t:'MTcyNjcyMTYwNy4wMDAwMDA='};var a=document.createElement('script');a.nonce='';a.src='/cdn-cgi/challenge-platform/scripts/jsd/main.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script><iframe height="1" width="1" style="position: absolute; top: 0px; left: 0px; border: none; visibility: hidden;" src="./inhrtns1_files/saved_resource(3).html"></iframe>


<script type="text/javascript" id="" charset="">(function(a,e,b,f,g,c,d){a[b]=a[b]||function(){(a[b].q=a[b].q||[]).push(arguments)};c=e.createElement(f);c.async=1;c.src="https://www.clarity.ms/tag/"+g;d=e.getElementsByTagName(f)[0];d.parentNode.insertBefore(c,d)})(window,document,"clarity","script","ew6y4c1gqd");</script><img src="./inhrtns1_files/px.gif" style="display: none !important; width: 1px !important; height: 1px !important;"><img src="https://ad.doubleclick.net/favicon.ico?ad=300x250&amp;ad_box_=1&amp;adnet=1&amp;showad=1&amp;size=250x250" style="display: none !important; width: 1px !important; height: 1px !important;"><img src="./inhrtns1_files/px(1).gif" style="display: none !important; width: 1px !important; height: 1px !important;"><iframe src="./inhrtns1_files/syncframe.html" width="0" height="0" frameborder="0" sandbox="allow-scripts allow-same-origin" title="Criteo GUM iframe" style="border-width: 0px; margin: 0px; display: none;"></iframe><div class=" ace_editor ace_hidpi ace_autocomplete ace_dark ace-idle-fingers" style="font-size: medium; top: 293px; left: 446.391px; height: 66px; display: none;"><textarea class="ace_text-input" wrap="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="opacity: 0; font-size: 1px; transform: translate(-100px, 0px);"></textarea><div class="ace_gutter" aria-hidden="true" style="display: none; left: 0px; width: 41px;"><div class="ace_layer ace_gutter-layer ace_folding-enabled" style="height: 1e+06px; transform: translate(0px, 0px); width: 41px;"><div class="ace_gutter-cell " style="height: 22px; top: 0px;">1<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 22px;">2<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 44px;">3<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 66px;">4<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 88px;">5<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 110px;">6<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 132px;">7<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 154px;">8<span style="display: none;"></span></div><div class="ace_gutter-cell " style="height: 22px; top: 176px;">9<span style="display: none;"></span></div></div></div><div class="ace_scroller" style="line-height: 22px; left: 0px; right: 0px; bottom: 0px;"><div class="ace_content" style="cursor: default; transform: translate(0px, 0px); width: 298px; height: 110px;"><div class="ace_layer ace_print-margin-layer"><div class="ace_print-margin" style="left: 644px; visibility: hidden;"></div></div><div class="ace_layer ace_marker-layer"><div class="ace_active-line" style="height: 22px; top: 0px; left: 0px; right: 0px;"></div></div><div class="ace_layer ace_text-layer" style="height: 1e+06px; margin: 0px 4px; transform: translate(0px, 0px);"><div class="ace_line ace_selected" style="height: 22px; top: 0px;"><span class="ace_completion-highlight">static</span><span class="ace_completion-meta">local</span></div><div class="ace_line" style="height: 22px; top: 22px;"><span class="ace_">In</span><span class="ace_completion-highlight">sta</span><span class="ace_">n</span><span class="ace_completion-highlight">ti</span><span class="ace_">ationEx</span><span class="ace_completion-highlight">c</span><span class="ace_">eption</span><span class="ace_completion-meta">keyword</span></div><div class="ace_line" style="height: 22px; top: 44px;"><span class="ace_">Un</span><span class="ace_completion-highlight">s</span><span class="ace_">uppor</span><span class="ace_completion-highlight">t</span><span class="ace_">edOper</span><span class="ace_completion-highlight">ati</span><span class="ace_">onEx</span><span class="ace_completion-highlight">c</span><span class="ace_">eption</span><span class="ace_completion-meta">keyword</span></div></div><div class="ace_layer ace_marker-layer"></div><div class="ace_layer ace_cursor-layer ace_hidden-cursors" style="opacity: 0;"><div class="ace_cursor" style="display: block; transform: translate(4px, 0px); width: 8px; height: 22px;"></div></div></div></div><div class="ace_scrollbar ace_scrollbar-v" style="width: 20px; bottom: 0px; display: none;"><div class="ace_scrollbar-inner" style="width: 20px; height: 66px;">&nbsp;</div></div><div class="ace_scrollbar ace_scrollbar-h" style="display: none; height: 20px; left: 0px; right: 0px;"><div class="ace_scrollbar-inner" style="height: 20px; width: 283px;">&nbsp;</div></div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: hidden;"><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font: inherit; overflow: visible;">הההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההההה</div><div style="height: auto; width: auto; top: 0px; left: 0px; visibility: hidden; position: absolute; white-space: pre; font-style: inherit; font-variant: inherit; font-stretch: inherit; font-size: inherit; line-height: inherit; font-family: inherit; overflow: visible;"></div></div></div></body></html>